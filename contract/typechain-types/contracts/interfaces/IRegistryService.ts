...
export interface IRegistryServiceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addWallet"
      | "getAttribute"
...
export interface IRegistryService extends BaseContract {
  connect(runner?: ContractRunner | null): IRegistryService;
  waitForDeployment(): Promise<this>;

  interface: IRegistryServiceInterface;
